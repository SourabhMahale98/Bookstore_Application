...
INSERT INTO BOOKS (id, name, price, authors, isbn, publisher, published_on)
	VALUES (10, 'The Last Olympian', '150.68', 'Rick Riordan', '9781423101475', 'Disney Hyperion', '2009-05-05');
INSERT INTO BOOKS (id, name, price, authors, isbn, publisher, published_on)
	VALUES (11, 'Hannibal', '66.6', 'Thomas Harris', '0385334877', 'Delacorte Press', '1999-06-08');

INSERT INTO BOOKS (id, name, price, authors, isbn, publisher, published_on)
	VALUES (12, 'The Hunger Games', '132.00', 'Suzanne Collins', '9780439023528', 'Scholastic Press', '2008-09-14');

INSERT INTO BOOKS (id, name, price, authors, isbn, publisher, published_on)
	VALUES (13, 'Life of Pi', '26.95', 'Yann Martel', '0676973760', 'Knopf Canada', '2001-09-11');

INSERT INTO BOOKS (id, name, price, authors, isbn, publisher, published_on)
	VALUES (14, 'The Last Olympian', '150.68', 'Rick Riordan', '9781423101475', 'Disney Hyperion', '2009-05-05');

INSERT INTO BOOKS (id, name, price, authors, isbn, publisher, published_on)
	VALUES (15, 'The Last Olympian', '150.68', 'Rick Riordan', '9781423101475', 'Disney Hyperion', '2009-05-05');
